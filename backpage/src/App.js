            ...
            <Layout>
                ...
                >
                    ...
                    <Menu theme="dark" mode="inline" defaultSelectedKeys={['/app/ui/buttons']}>
                        ...
                        >
                            <Menu.Item key="/app/form/inputtest"><Link to={'/app/form/inputtest'}>Input</Link></Menu.Item>
                        </SubMenu>
                        <SubMenu
                            key="/app/feedback"
                            title={<span><Icon type="scan" /><span className="nav-text">Feedback</span></span>}
                        >
                            <Menu.Item key="/app/feedback/alerttest"><Link to={'/app/feedback/alerttest'}>Alert</Link></Menu.Item>
                        </SubMenu>
                        <Menu.Item key="3">
                            <Icon type="upload" />
